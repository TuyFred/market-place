# AFROLUXO
=======
## African-inspired fashion e-commerce (clothes)

Full‑stack shop for **AFROLUXO** — African traditional, Ankara prints, modern casual, women/men/kids wear, formal, and street style:

- **Brand**: AFROLUXO · Canada
- **Frontend**: React, Vite, TypeScript, Tailwind CSS
- **Backend**: Fastify (Node.js), Supabase (PostgreSQL + Storage + Auth)
- **Admin**: Sign in as admin/manager → `/admin/dashboard` to add products & categories
...
- **GET `/products`**
  ...
  - Query params:
    - `category` (optional string; e.g. `african-traditional`, `modern-casual`, `women-wear`)
...
- **Products page**
  - Grid of all clothes with category filtering (African, Ankara, modern, women/men/kids, formal, street).
  - Each product card:
