    ...
    return (
      <div className="container mx-auto px-4 py-20 text-center max-w-lg">
        ...
        <button
          ...
          className="inline-block px-10 py-4 bg-slate-900 text-white font-bold rounded-2xl hover:bg-slate-800 transition-all shadow-xl shadow-slate-950/20 active:scale-95"
        >
          Sign In Now
        </button>
      </div>
            ...
            {orders.map((order) => (
              <div key={order.id} className="group premium-card !rounded-[2rem] flex flex-col md:flex-row animate-reveal">
                ...
                <div className="p-8 flex-1 border-r border-slate-50">
                  ...
                  <h3 className="text-xl font-black text-slate-900 mb-1">{order.products?.name || 'AFROLUXO Order'}</h3>
