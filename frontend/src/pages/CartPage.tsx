      ...
      <div className="premium-card !rounded-[2.5rem] p-8 space-y-6 lg:sticky lg:top-24 h-fit">
        ...
        <form onSubmit={handleCheckout} className="space-y-4 pt-4 border-t border-slate-100">
          ...
          <button
            ...
            className="w-full inline-flex items-center justify-center gap-2 rounded-xl border-2 border-emerald-100 bg-emerald-50 px-6 py-3 text-[9px] font-black uppercase text-emerald-700 hover:bg-emerald-100 transition-all active:scale-95"
          >
