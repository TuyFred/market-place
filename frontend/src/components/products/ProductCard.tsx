          ...
          <div className="mt-6 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className="shimmer-on-hover group/btn flex items-center justify-center gap-2 rounded-xl bg-[#ecfdf5] border border-emerald-100 px-3 py-2.5 text-[9px] font-black tracking-widest uppercase text-emerald-700 transition-all hover:bg-emerald-100 active:scale-95"
              >
              ...
              <button
                onClick={handleEmail}
                className="group/btn flex items-center justify-center gap-2 rounded-xl bg-slate-50 border border-slate-100 px-3 py-2.5 text-[9px] font-black tracking-widest uppercase text-slate-700 transition-all hover:bg-slate-100 active:scale-95"
              >
              ...
              <div className="w-full lg:w-[450px] p-8 sm:p-10 flex flex-col gap-8 overflow-y-auto bg-white border-l border-slate-100">
                <div className="flex justify-between items-start">
                  <div className="space-y-4">
                    ...
                    <h2 className="text-3xl font-black text-slate-900 leading-[1.05] tracking-tight">
                      {product.name}
                    </h2>
                  </div>
                  <button
