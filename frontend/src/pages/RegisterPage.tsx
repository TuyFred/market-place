    ...
    <div className="min-h-screen bg-[#0f2540] flex flex-col items-center justify-center p-6">
      ...
      <div className="relative w-full max-w-[420px]">
        ...
        <div className="relative mx-auto bg-[#0b1726]/95 border border-slate-800 rounded-2xl shadow-2xl px-8 py-8 w-full">
          <h2 className="text-2xl text-amber-400 font-bold text-center mb-3">Join AFROLUXO</h2>
          <p className="text-center text-sm text-slate-300 mb-4">Sign up to track orders with AFROLUXO.</p>
