    ...
    <div className="container mx-auto px-4 py-12 max-w-6xl animate-reveal">
      ...
      <div className="premium-card !rounded-[2.5rem] p-8 space-y-6 lg:sticky lg:top-24 h-fit">
        ...
        <form onSubmit={handleCheckout} className="space-y-4 pt-4 border-t border-slate-100">
          ...
          <input
            className="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-xs font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all"
          ...
          <button
            ...
            className="mt-4 w-full inline-flex items-center justify-center rounded-2xl bg-indigo-600 px-6 py-4 text-xs font-black text-white shadow-xl shadow-indigo-600/20 hover:bg-indigo-700 transition-all active:scale-95 disabled:opacity-60 shimmer-on-hover"
          >
            {submitting
              ? 'Processing...'
              : isAuthenticated
          ...
          <button
            ...
            className="w-full inline-flex items-center justify-center gap-2 rounded-2xl border-2 border-emerald-100 bg-emerald-50 px-6 py-4 text-[10px] font-black uppercase text-emerald-700 hover:bg-emerald-100 transition-all active:scale-95"
          >
